...
export const sampleData3: BoardApiShape = {
  boardId: "board-1",
  groups: [
    { id: "group-a" as UUID, title: "Group First",  taskIds: ["task-1" as UUID, "task-2" as UUID] },
    { id: "group-b" as UUID, title: "Group Second", taskIds: ["task-3" as UUID, "task-4" as UUID] }
  ],
  tasks: {
    "task-1": { id: "task-1" as UUID, groupId: "group-a" as UUID, description: "task 1", completed: false,},
    "task-2": { id: "task-2" as UUID, groupId: "group-a" as UUID, description: "task 2", completed: false,},
    "task-3": { id: "task-3" as UUID, groupId: "group-b" as UUID, description: "task 3", completed: false,},
    "task-4": { id: "task-4" as UUID, groupId: "group-b" as UUID, description: "task 4", completed: false,}
  }
}
  ...
  "groups": [
    {
      ...
      "position": 0,
      "tasks": [
        { "id": "task-uuid-1", "description": "...", "completed": false, "position": 0 },
        { "id": "task-uuid-2", "description": "...", "completed": false, "position": 1 }
      ]
    },
    {
      "id": "group-uuid-2",
